...
class Discover extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<Destination> destinations = [
      Destination('assets/images/aracheology.jpg', 'Archaeological Sites'),
      Destination('assets/images/m.jpg', 'Museums'),
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return GestureDetector(
            onTap: () {
              if (dest.name == 'Archaeological Sites') {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const ArchaeologicalSiteScreen(),
                  ),
                );
              } else if (dest.name == 'Museums') {
                Navigator.push(
                  context,
                  MaterialPageRoute(
              ...
              } else if (dest.name == 'Historical Buildings') {
                Navigator.push(
                  context,
                  MaterialPageRoute(
