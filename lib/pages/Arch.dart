...
class ArchaeologicalSiteScreen extends StatelessWidget {
  const ArchaeologicalSiteScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Archaeological Sites'), // set the title to "Museums"
      ),
      body: SafeArea(
        child: Column(
          children: [
